...
No build or package installation is required. The presentation has no external runtime dependencies.
...
Run the deterministic repository smoke test with the Node.js runtime already installed:
